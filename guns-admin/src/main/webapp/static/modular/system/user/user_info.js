...
UserInfoDlg.addSubmit = function () {
    ...
    if (!this.validatePwd()) {
        yaluzb.error("两次密码输入不一致");
        return;
    }

    //提交信息
    var ajax = new $ax(yaluzb.ctxPath + "/mgr/add", function (data) {
        yaluzb.success("添加成功!");
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(yaluzb.ctxPath + "/mgr/edit", function (data) {
        yaluzb.success("修改成功!");
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(yaluzb.ctxPath + "/mgr/changePwd", function (data) {
        yaluzb.success("修改成功!");
    }, function (data) {
        yaluzb.error("修改失败!" + data.responseJSON.message + "!");
    });
...
$(function () {
    yaluzb.initValidator("userInfoForm", UserInfoDlg.validateFields);
