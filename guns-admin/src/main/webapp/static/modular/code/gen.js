...
Code.generate = function () {
    ...
    var baseAjax = yaluzb.baseAjax("/code/generate", "生成代码");
...
Code.setTableName = function (tableName) {
    ...
    $("#className").val(yaluzb.underLineToCamel(tableName.substring(preSize)));
};
...
Code.showMenuSelectTree = function () {
    yaluzb.showInputTree("parentMenuName", "pcodeTreeDiv", 15, 34);
};
