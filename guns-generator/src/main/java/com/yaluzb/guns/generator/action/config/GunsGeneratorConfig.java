package com.yaluzb.guns.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.yaluzb.guns.admin.common.persistence.model");
        packageConfig.setMapper("com.yaluzb.guns.admin.common.persistence.dao");
        packageConfig.setXml("com.yaluzb.guns.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.yaluzb.guns.admin");
        contextConfig.setCoreBasePackage("com.yaluzb.guns.core");
