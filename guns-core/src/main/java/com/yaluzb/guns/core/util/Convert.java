...
import com.yaluzb.guns.core.support.*;
import com.yaluzb.guns.core.support.exception.ToolBoxException;
    ...
    public static Object parse(Class<?> clazz, Object value) {
        try {
            if (clazz.isAssignableFrom(String.class)) {
                // ----2016-12-19---yaluzb----防止beetlsql对空字符串不检测导致无法入库的问题----
            ...
            if (Date.class.isAssignableFrom(clazz)) {
                // 判断标准日期
                // ----2016-11-24---yaluzb----需要加toDate(),不然beetlsql转换date类型的时候会报错----
